    ...
    public void getMessage() throws Exception {
        ...
        StompSessionHandler handler = new TestSessionHandler(failure) {
            ...
            public void afterConnected(final StompSession session, StompHeaders connectedHeaders) {
                session.subscribe("/topic/public-chat", new StompFrameHandler() {
                    @Override
                    ...
                    public void handleFrame(StompHeaders headers, Object payload) {
                        ...
                        try {
                            ...
                            assertEquals("Vitor", chatMessage.getSentBy());
                        } catch (Throwable t) {
                            failure.set(t);
                        } finally {
                            session.disconnect();
                ...
                try {
                    session.send("/app/chat", new ChatMessageInput("Hello", "Vitor"));
                } catch (Throwable t) {
                    failure.set(t);
                    latch.countDown();
                }
